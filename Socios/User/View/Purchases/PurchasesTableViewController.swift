...
class PurchasesTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    func updateSearchResults(for searchController: UISearchController) {
        if searchController.searchBar.text! == "" {
            ...
            filteredData = response!.filter{
                let purchaseObject = $0 as! [String:Any]
                let s: String = purchaseObject["name"] as! String;
    ...
    override func viewDidLoad() {
        ...
        if let err = err {
            ...
            let compras = querySnapshot!.documents.first?.data()["products"] as? Array<[String: Any]> ?? []
            self.response = []
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        let purchaseObject = filteredData[indexPath.row] as! [String: Any]
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let nextView = segue.destination as! PurchasesDetailViewController
